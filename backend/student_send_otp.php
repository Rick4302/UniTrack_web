...
try {
    ...
    // Professional HTML email template (matching forgot password design)
    $mail->Body = "
        <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>
            <h2 style='color: #daa520;'>Email Verification Required</h2>
            <p>Welcome to UniTrack! To complete your account registration, please verify your email address.</p>
            <div style='background-color: #f4f4f4; padding: 20px; text-align: center; margin: 20px 0; border-left: 4px solid #daa520;'>
                <p style='color: #666; margin: 0 0 10px 0; font-size: 14px;'>Your Verification Code:</p>
                <h1 style='color: #daa520; font-size: 48px; margin: 0; letter-spacing: 5px;'>{$otp}</h1>
            </div>
